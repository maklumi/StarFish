...
//    }
    ...
    companion object {
         ...
         */
        fun getList(stage: Stage, className: KClass<out BaseActor>): ArrayList<BaseActor> {
            val list = ArrayList<BaseActor>()

            val theClass: Class<out BaseActor> = className.java
         ...
         */
        fun count(stage: Stage, className: KClass<out BaseActor>): Int {
